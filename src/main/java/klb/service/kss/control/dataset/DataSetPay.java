...
public class DataSetPay {
	...
	private String labelBenAccount = "BenAccount";
	private String labelBenName = "BenName";
	private String labelBenBank = "BenBank";
	...
	private String labelPayAccount = "PayAccount";
	private String labelStatus = "Status";
	private String labelReason = "Reason";
	private List<DataLinePay> ds;
	...
	public String getHeaderLine() {
		...
		buildStr.append("," + labelBenAccount);
		buildStr.append("," + labelBenName);
		buildStr.append("," + labelBenBank);
		buildStr.append("," + labelAmount);
		buildStr.append("," + labelFee);
		buildStr.append("," + labelTax);
		buildStr.append("," + labelNarratives);
		buildStr.append("," + labelPayAccount);
	...
	public String genDataFile() {
		...
		for (int i = 0; i < ds.size(); i++) {
			...
			strResult.append("," + obj.getBenAccount());
			strResult.append("," + obj.getBenName());
			strResult.append("," + obj.getBenBank());
			strResult.append("," + obj.getAmount());
			strResult.append("," + obj.getFee());
			strResult.append("," + obj.getTax());
			strResult.append("," + obj.getNarratives());
			strResult.append("," + obj.getPayAccount());
	...
	public List<DataLinePay> getDs() {
		return ds;
	}

	public void setDs(List<DataLinePay> ds) {
		this.ds = ds;
	}
	...
	public String getLabelBenAccount() {
		return labelBenAccount;
	}

	public String getLabelBenName() {
		return labelBenName;
	}

	public String getLabelBenBank() {
		return labelBenBank;
	}
	...
	public String getLabelPayAccount() {
		return labelPayAccount;
	}
